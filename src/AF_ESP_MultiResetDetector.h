...
#ifndef AF_ESP_MultiResetDetector_H
#define AF_ESP_MultiResetDetector_H
  ...
  #define ESP_MULTI_RESET_DETECTOR_VERSION             "AF_ESP_MultiResetDetector v1.3.3"

  #define ESP_MULTI_RESET_DETECTOR_VERSION_MAJOR       1
  #define ESP_MULTI_RESET_DETECTOR_VERSION_MINOR       3
  #define ESP_MULTI_RESET_DETECTOR_VERSION_PATCH       3

  #define ESP_MULTI_RESET_DETECTOR_VERSION_INT         1003003
#endif
...
#endif // AF_ESP_MultiResetDetector_H
